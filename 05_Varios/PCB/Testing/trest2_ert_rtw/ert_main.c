...
void rt_OneStep(void)
{
  ...
  currentTime = (extmodeSimulationTime_T) trest2_M->Timing.clockTick0;
  trest2_step();
...
int main(void)
{
  ...
  errorCode = extmodeInit(trest2_M->extModeInfo, &rtmGetTFinal(trest2_M));
  if (errorCode != EXTMODE_SUCCESS) {
  ...
  if (errorCode == EXTMODE_SUCCESS) {
    ...
    if (extmodeStopRequested()) {
      rtmSetStopRequested(trest2_M, true);
    }
  }
