...
void SPWM_step(void)
{
   ...
   */
  rtb_Gain1 = sin(SPWM_P.Gain_Gain * SPWM_DW.Delay_DSTATE);
   ...
   */
  rtb_Gain3 = (SPWM_P.Gain4_Gain * rtb_Gain1 + SPWM_P.Constant3_Value) *
    SPWM_P.Gain3_Gain;
   ...
   *  Sum: '<S1>/Sum2'
   */
  rtb_Gain1 = (SPWM_P.Gain2_Gain * rtb_Gain1 * SPWM_P.Gain5_Gain +
               SPWM_P.Constant3_Value) * SPWM_P.Gain1_Gain;

  /* S-Function (c2802xpwm): '<Root>/ePWM1' */

  /*-- Update CMPA value for ePWM2 --*/
  {
    EPwm2Regs.CMPA.bit.CMPA = (uint16_T)((uint32_T)EPwm2Regs.TBPRD * rtb_Gain3 *
      0.01);
  }

  /*-- Update CMPB value for ePWM2 --*/
  {
    EPwm2Regs.CMPB.bit.CMPB = (uint16_T)((uint32_T)EPwm2Regs.TBPRD * rtb_Gain1 *
      0.01);
  }
...
void SPWM_initialize(void)
{
  ...
  /* External mode info */
  SPWM_M->Sizes.checksums[0] = (2126398354U);
  SPWM_M->Sizes.checksums[1] = (2048102759U);
  SPWM_M->Sizes.checksums[2] = (1858095743U);
  SPWM_M->Sizes.checksums[3] = (402796381U);
  ...
  /*** Initialize ePWM2 modules ***/
  {
    ...
    EPwm2Regs.TBPRD = 4000U;           // Time Base Period Register
  ...
  /* InitializeConditions for Gain: '<S1>/Gain1' incorporates:
   *  Delay: '<S1>/Delay'
   */
